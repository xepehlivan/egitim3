sap.ui.define([
	...
	return Opa5.extend("Renova.egitim3.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Renova/egitim3/localService/mockserver"], function (mockserver) {
